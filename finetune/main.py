...
from engine import train_one_epoch, evaluate, metrics
...
def get_args_parser():
    ...
    parser.add_argument('--show-para', action='store_true')
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/ljtj/PycharmProjects/data/final_data_2', type=str,
                        help='dataset path')
    parser.add_argument('--start-point', default='models/student_attn_only_out_val_checkpoint0000.pth', type=str,
                        help='start path')
    parser.add_argument('--data-set', default='FINAL_DATA',
                        type=str, help='Image Net dataset path')
    parser.add_argument('--inat-category', default='name',
                        choices=['kingdom', 'phylum', 'class', 'order', 'supercategory', 'family', 'genus', 'name'],
                        type=str, help='semantic granularity')
    parser.add_argument('--output_dir', default='./notebooks/test',
    ...
    parser.add_argument('--use_pvt', default=False, action='store_true',
                        help="""Whether to use the pvt weight""")
    return parser
...
def main(args):
    ...
    model = create_model(
        args.model,
        checkpoint_path=args.start_point,
        pretrained=args.use_pvt,
        num_classes=int(args.nb_classes),
        # drop_rate=args.drop,
    ...
    if args.attn_only:
        for name_p, p in model.named_parameters():
            ...
            elif "fc" in name_p or 'head' in name_p:
    ...
    if args.eval:
        ...
        test = metrics(data_loader_val, model, device)
        print(test)
...
if __name__ == '__main__':
    # parser = argparse.ArgumentParser('dataset test', parents=[get_args_parser()])
    # args = parser.parse_args()
    # dataset_train, nb_classes = build_dataset(is_train=True, args=args)
    # data_loader = torch.utils.data.DataLoader(dataset_train, batch_size=1, shuffle=False)
    #
